...
namespace RevXApi.Library.Services
{
	public class EmailService : IEmailService
	{
		...
		public async Task SendEmail()
		{
			...
			sessions.Add(new() { Student = "First Last", Date = DateTime.Now, StartTime = new TimeSpan(), EndTime = new TimeSpan(), Notes = "Hello In the email." });
			sessions.Add(new() { Student = "First Last", Date = DateTime.Now.AddDays(-2), StartTime = new TimeSpan(), EndTime = new TimeSpan(), Notes = "second one." });
			sessions.Add(new() { Student = "First Last", Date = DateTime.Now, StartTime = new TimeSpan(), EndTime = new TimeSpan(), Notes = "Hello In the email." });
			sessions.Add(new() { Student = "First Last", Date = DateTime.Now, StartTime = new TimeSpan(), EndTime = new TimeSpan(), Notes = "Hello In the email." });
